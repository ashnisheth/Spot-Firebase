...
See LICENSE folder for this sample’s licensing information.
 ...
 This file has been modified from its original version by Ashni Sheth.

Abstract:
Makes predictions from images using the CelebrityIdentifier model.
*/
...
class ImagePredictor {
    ...
    static func createImageClassifier() -> VNCoreMLModel {
        ...
        let imageClassifierWrapper = try? SpotCarDetector(configuration: defaultConfig)
        //The model specified above uses slightly modified data from a Kaggle dataset: https://www.kaggle.com/danupnelson/14-celebrity-faces-dataset
